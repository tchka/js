class Board {
     ...
     * для работы.
     * @param {Status} status объект состояния игры.
     */
    init(status) {
        this.status = status;
    }
    ...
    isCellEmpty(event) {
        ...
        return this.gameTableElement.querySelector(`[data-row='${row}'][data-col='${col}']`).innerHTML === '';
    }
    /**
    ...
    fillCell(event) {
        ...
        this.gameTableElement.querySelector(`[data-row='${row}'][data-col='${col}']`).innerHTML = this.phase;
     ...
     */
    isLineWon(a, b, c) {
        let value = this.gameTableElement.querySelector(`[data-row='${a.y}'][data-col='${a.x}']`).innerHTML +
            this.gameTableElement.querySelector(`[data-row='${b.y}'][data-col='${b.x}']`).innerHTML +
            this.gameTableElement.querySelector(`[data-row='${c.y}'][data-col='${c.x}']`).innerHTML;
